...
*/
/**************************************************************************/
inline U8 Souliss_DigInHold_Helper(U8 pin, U8 pin_value, U8 value, U8 value_hold, U8 *memory_map, U8 slot, unsigned long holdtime)
{
	// If pin is on, set the "value"
	if(pin_value && (InPin[pin]==PINRESET))
	{
...
U8 Souliss_DigInHold(U8 pin, U8 value, U8 value_hold, U8 *memory_map, U8 slot, unsigned long holdtime=1500)
{
	return Souliss_DigInHold_Helper(pin, dRead(pin), value, value_hold, memory_map, slot, holdtime);
}

U8 Souliss_LowDigInHold(U8 pin, U8 value, U8 value_hold, U8 *memory_map, U8 slot, unsigned long holdtime=1500)
{
	return Souliss_DigInHold_Helper(pin, !dRead(pin), value, value_hold, memory_map, slot, holdtime);
}


U8 Souliss_DigInHoldCustom(U8 pin, U8 value, U8 value_hold, U8 *memory_map, U8 slot, unsigned long holdtime)
{
	return Souliss_DigInHold_Helper(pin, dRead(pin), value, value_hold, memory_map, slot, holdtime);
}

U8 Souliss_LowDigInHoldCustom(U8 pin, U8 value, U8 value_hold, U8 *memory_map, U8 slot, unsigned long holdtime)
{
	return Souliss_DigInHold_Helper(pin, !dRead(pin), value, value_hold, memory_map, slot, holdtime);
}
