...
#define	DigInHoldCustom(pin, value_state1,value_state2,slot,holdtime)			Souliss_DigInHoldCustom(pin, value_state1, value_state2, memory_map, slot,holdtime)
#define	LowDigInHoldCustom(pin, value_state1,value_state2,slot,holdtime)		Souliss_LowDigInHoldCustom(pin, value_state1, value_state2, memory_map, slot,holdtime)
